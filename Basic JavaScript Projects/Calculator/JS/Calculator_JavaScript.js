...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //we are saying that if the display values does not contain a decimal point 
...
function Handle_Operator(Next_Operator) {
    ...
    //when an operator key is pressed, we conver the curren tnumber
    ...
    //then updates the operator adn exits from the function
